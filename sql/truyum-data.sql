...
insert into truyum.menu_item(me_name,me_price,me_active,me_date_of_launch,me_category,me_free_delivery) values ('Chocolate Brownie',32.00,'Yes','2022-11-02','Desert','Yes');
...
-- a. Retrieving particular menu items(Customer view)
...
insert into truyum.user(us_name) values('Hari'),('Vicky');

insert into truyum.cart(ct_us_id,ct_pr_id) values(1,1),(1,1),(1,3);
